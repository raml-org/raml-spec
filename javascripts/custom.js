$(document).ready(function() {
    ...
    /* Code screenshot swapping on hover */
    $('img.code-showall').delay(400).fadeIn('slow',function() {
        $('img.code-inactive').delay(400).fadeIn();
    });
    $('.code-highlight').delay(1500).queue(function() {
        $('.code-highlight.code-1').addClass('active');
        $(this).addClass('inactive');
    });
    $('.code-highlight').hover(function() {
        $('.code-highlight').removeClass('active');
