...
Parameters cannot be used within any file location used in the context of [modularization](https://github.com/raml-org/raml-spec/blob/master/versions/raml-10/raml-10.md#modularization), that is any file location defined in the `!include` tag or as value of any of the `uses` and `extends` nodes.
